 ...
 *
 * OBS.: Qualquer pacote corrompido sera descartado pelo servidor, nao 
 * gerando resposta ao cliente.
...
/**
 * Imprime um pacote SDTP
 *
 * Serao exibidos todos os campos do pacote, havendo dados (datalen > 0),
 * este tambem exibira os dados do pacote.
 *
 * \param p Ponteiro para o pacote que se deseja imprimir.
 */
